...
```bash
pnpm add chat-adapter-qqbot chat
```
...
```ts
import { createQQBotAdapter } from "chat-adapter-qqbot";
...
```ts
import { decodeQQBotThreadId, encodeQQBotThreadId } from "chat-adapter-qqbot";
...
```ts
import { decodeQQBotButtonData, encodeQQBotButtonData } from "chat-adapter-qqbot";
...
```ts
export { QQBotAdapter } from "chat-adapter-qqbot";
export { createQQBotAdapter, resolveConfig } from "chat-adapter-qqbot";
export { QQBotClient, resolveApiBaseUrl } from "chat-adapter-qqbot";
export { QQBotFormatConverter } from "chat-adapter-qqbot";
export { encodeQQBotThreadId, decodeQQBotThreadId } from "chat-adapter-qqbot";
export { encodeQQBotButtonData, decodeQQBotButtonData } from "chat-adapter-qqbot";
export type * from "chat-adapter-qqbot";
```
...
- `pnpm example:websocket`: run the local QQBot Gateway/WebSocket example.
